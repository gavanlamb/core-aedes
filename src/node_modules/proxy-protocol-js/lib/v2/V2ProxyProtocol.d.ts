import { AddressFamilyType } from 'proxy-protocol-js/lib/v2/enum/AddressFamily';
import { Command } from 'proxy-protocol-js/lib/v2/enum/Command';
import { TransportProtocol } from 'proxy-protocol-js/lib/v2/enum/TransportProtocol';
import { IPv4ProxyAddress } from 'proxy-protocol-js/lib/v2/proxy_address/IPv4ProxyAddress';
import { IPv6ProxyAddress } from 'proxy-protocol-js/lib/v2/proxy_address/IPv6ProxyAddress';
import { UnixProxyAddress } from 'proxy-protocol-js/lib/v2/proxy_address/UnixProxyAddress';
import { UnspecProxyAddress } from 'proxy-protocol-js/lib/v2/proxy_address/UnspecProxyAddress';
